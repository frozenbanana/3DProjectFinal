...
make: Display.o Shader.o Model.o Mesh.o Camera.o LightHandler.o Light.o PntLight.o DirLight.o SptLight.o GBuffer.o Terrain.o QuadTree.o PingPongBuffer.o LBuffer.o
...
LBuffer.o: LBuffer.cpp
		$(CC) $(CFLAGS) LBuffer.cpp -c
clean:
		-rm *.o
		-rm run

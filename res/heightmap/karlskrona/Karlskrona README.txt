...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Karlskrona&box=15.760829,56.266395,15.453482,56.095716
...
-----------
  ...
  * Karlskrona Height Map (ASTER 30m).png
  ...
  * Karlskrona Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Karlskrona Height Map (SRTM3 v4.1).png
  ...
  * Karlskrona Height Map (SRTM30 Plus).png

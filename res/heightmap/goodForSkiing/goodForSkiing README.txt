...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=goodForSkiing&box=6.030901,46.200937,5.784301,46.030257
...
-----------
  ...
  * goodForSkiing Height Map (ASTER 30m).png
  ...
  * goodForSkiing Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * goodForSkiing Height Map (SRTM3 v4.1).png
  ...
  * goodForSkiing Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 275m (actual) is equal to 40m in
